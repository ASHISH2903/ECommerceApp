...
import myapp.myecommerce.myapplication.Model.Cart;
import myapp.myecommerce.myapplication.Prevalent.Prevalent;
import myapp.myecommerce.myapplication.R;
import myapp.myecommerce.myapplication.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists())
                {
                    ...
                    if(shippingState.equals("shipped"))
                    {
                        ...
                        Toast.makeText(CartActivity.this, "You can purchase more products, Once you receive your final first order.", Toast.LENGTH_SHORT).show();
                    }
