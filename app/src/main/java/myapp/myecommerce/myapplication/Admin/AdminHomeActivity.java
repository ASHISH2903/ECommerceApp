...
import myapp.myecommerce.myapplication.Buyers.HomeActivity;


public class AdminHomeActivity extends AppCompatActivity {

    private Button LogoutBtn, CheckOrdersBtn,maintainProductsBtn, CheckApprovedProductBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckApprovedProductBtn = (Button) findViewById(R.id.check_approve_product_btn);
